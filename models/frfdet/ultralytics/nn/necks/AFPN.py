...
def BasicConv(filter_in: int, filter_out: int, kernel_size: int, stride: int = 1):
...
class ASFF_2(nn.Module):
    def __init__(self, inter_dim: int = 512):
...
class ScaleBlockBody(nn.Module):
    def __init__(self, channels: t.List = [128, 256, 512]):
...
class AFPN(nn.Module):
    def __init__(self, in_channels: t.List = [256, 512, 1024], out_channels: t.List = [256, 512, 1024]):
