_base_ = [
    '../_base_/antiuav_dataset.py',
    '../_base_/schedule_mmdet_300e.py',
]

# Faster R-CNN R50-FPN, single class (UAV), 768x1344, 300ep official SGD.
# COCO-pretrained backbone (torchvision resnet50) for fair transfer.
model = dict(
    type='FasterRCNN',
...
# COCO-pretrained Faster R-CNN; the 1-class bbox head re-inits on mismatch.
