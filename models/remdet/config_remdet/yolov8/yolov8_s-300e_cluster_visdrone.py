...
# -----data related-----
data_root = '/mnt/datasets/VisDrone2019-ClusDET/'  # Root path of data  /mnt/exam_log/remdet-mmdet/
# Path of train annotation file
train_ann_file = 'annotations/VisDrone2019-DET-train-ca.json'
train_data_prefix = 'images/train'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/VisDrone2019-DET-val-ca.json'
