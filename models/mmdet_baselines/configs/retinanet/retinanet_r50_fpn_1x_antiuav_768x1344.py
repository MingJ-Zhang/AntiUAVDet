...
# RetinaNet R50-FPN, single class (UAV), 768x1344, 300ep official SGD.
model = dict(
    type='RetinaNet',
    ...
    test_cfg=dict(nms_pre=1000, min_bbox_size=0, score_thr=0.001,
                  nms=dict(type='nms', iou_threshold=0.7),
                  max_per_img=100))

# Official MMDetection RetinaNet R50-FPN optimizer (global batch 16).
optim_wrapper = dict(optimizer=dict(lr=0.01))

# COCO-pretrained RetinaNet
