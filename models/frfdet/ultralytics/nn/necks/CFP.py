...
class Encoding(nn.Module):
    def __init__(self, in_channels: int, num_codes: int):
    ...
    @staticmethod
    def scaled_l2(x: torch.Tensor, codewords: torch.Tensor, scale: torch.Tensor):
    ...
    @staticmethod
    def aggregate(assignment_weights: torch.Tensor, x: torch.Tensor, codewords: torch.Tensor):
        num_codes, in_channels = codewords.size()
