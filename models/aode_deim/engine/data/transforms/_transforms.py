...
class PadToSize(T.Pad):
    ...
    # torchvision >= 0.24 renamed _get_params() to make_params().
    # Keep both hooks so the project remains compatible with the pinned
    # torchvision 0.20.x and newer development environments.
