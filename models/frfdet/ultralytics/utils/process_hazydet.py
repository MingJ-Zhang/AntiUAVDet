...
def trans_to_voc(anno_dir: str, xml_dir: str, img_dir: str):
    ...
    with open(anno_dir, 'r') as f:
        ...
        for i in tqdm(range(len(imgs))):
            ...
            xml_content.append("	<folder>HazeVisDrone</folder>")
...
def draw_all_labels():
    xml_dir_path = r'C:\dataset\HazyData\train\hazy_xml'
    img_dir_path = r'C:\dataset\HazyData\train\hazy_images'
    img_out_dir = r'C:\dataset\HazyData\vis_gt'
...
if __name__ == '__main__':
    pass
    # trans_to_voc(
    #     r'C:\dataset\HazyData\train\train_coco.json',
    #     r'C:\dataset\HazyData\train\hazy_xml',
    #     r'C:\dataset\HazyData\train\hazy_images',
    # )
    #
    # trans_to_voc(
    #     r'C:\dataset\HazyData\val\val_coco.json',
    #     r'C:\dataset\HazyData\val\hazy_xml',
    #     r'C:\dataset\HazyData\val\hazy_images',
    # )
    #
    # trans_to_voc(
    #     r'C:\dataset\HazyData\test\test_coco.json',
    #     r'C:\dataset\HazyData\test\hazy_xml',
    #     r'C:\dataset\HazyData\test\hazy_images',
    # )

    # trans_to_voc(
    #     r'C:\dataset\HazyData\RDDTS\train_coco.json',
    #     r'C:\dataset\HazyData\RDDTS\hazy_xml',
    #     r'C:\dataset\HazyData\RDDTS\images'
    # )
    #
    # voc_to_yolo(
    #     r'C:\dataset\HazyData\train\hazy_xml',
    #     r'C:\dataset\HazyData\train\hazy_labels')
    # voc_to_yolo(
    #     r'C:\dataset\HazyData\test\hazy_xml',
    #     r'C:\dataset\HazyData\test\hazy_labels')
    # voc_to_yolo(
    #     r'C:\dataset\HazyData\val\hazy_xml',
    #     r'C:\dataset\HazyData\val\hazy_labels')

    # voc_to_yolo(
    #     r'C:\dataset\HazyData\RDDTS\annotations',
    #     r'C:\dataset\HazyData\RDDTS\labels'
    # )
    # draw_all_labels()
